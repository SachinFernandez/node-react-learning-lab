...
import DeploymentLesson from "../pages/DeploymentLesson.jsx";
...
import AuthMiddlewareLesson from "../pages/AuthMiddlewareLesson.jsx";
import AdvancedStreamsLesson from "../pages/AdvancedStreamsLesson.jsx";
...
import PasswordSecurity from "../pages/PasswordSecurity.jsx";
import ProtectedRoutesLesson from "../pages/ProtectedRoutesLesson.jsx";
...
import JwtAuthentication from "../pages/JwtAuthentication.jsx";
import ValidationErrors from "../pages/ValidationErrors.jsx";
import WebSocketsLesson from "../pages/WebSocketsLesson.jsx";
import WorkerThreadsLesson from "../pages/WorkerThreadsLesson.jsx";
import ChildProcessesLesson from "../pages/ChildProcessesLesson.jsx";
import PerformanceMemoryLesson from "../pages/PerformanceMemoryLesson.jsx";
import EnvironmentConfig from "../pages/EnvironmentConfig.jsx";
import LoggingErrors from "../pages/LoggingErrors.jsx";
import TestingLesson from "../pages/TestingLesson.jsx";

function AppRoutes() {
  return <Routes><Route element={<MainLayout />}><Route index element={<Dashboard />} /><Route path="learn/node-introduction" element={<NodeIntroduction />} /><Route path="learn/node-runtime" element={<NodeRuntime />} /><Route path="learn/event-loop" element={<EventLoop />} /><Route path="learn/blocking-vs-non-blocking" element={<BlockingVsNonBlocking />} /><Route path="learn/modules-npm" element={<ModulesAndNpm />} /><Route path="learn/async-javascript" element={<AsyncJavaScript />} /><Route path="learn/error-handling" element={<ErrorHandling />} /><Route path="learn/file-system" element={<FileSystemLesson />} /><Route path="learn/path-url" element={<PathUrlLesson />} /><Route path="learn/os-process" element={<OsProcessLesson />} /><Route path="learn/events" element={<EventsLesson />} /><Route path="learn/streams-buffers" element={<StreamsBuffersLesson />} /><Route path="learn/http-module" element={<HttpModuleLesson />} /><Route path="learn/express-fundamentals" element={<ExpressFundamentals />} /><Route path="learn/routing-controllers" element={<RoutingControllers />} /><Route path="learn/middleware" element={<MiddlewareLesson />} /><Route path="learn/rest-crud" element={<RestCrud />} /><Route path="learn/validation-errors" element={<ValidationErrors />} /><Route path="learn/mysql-connection" element={<MySqlConnection />} /><Route path="learn/mysql-queries" element={<MySqlQueries />} /><Route path="learn/service-layer" element={<ServiceLayer />} /><Route path="learn/mysql-crud" element={<MySqlCrud />} /><Route path="learn/password-security" element={<PasswordSecurity />} /><Route path="learn/jwt-auth" element={<JwtAuthentication />} /><Route path="learn/auth-middleware" element={<AuthMiddlewareLesson />} /><Route path="learn/protected-routes" element={<ProtectedRoutesLesson />} /><Route path="learn/worker-threads" element={<WorkerThreadsLesson />} /><Route path="learn/child-processes" element={<ChildProcessesLesson />} /><Route path="learn/advanced-streams" element={<AdvancedStreamsLesson />} /><Route path="learn/websockets" element={<WebSocketsLesson />} /><Route path="learn/performance-memory" element={<PerformanceMemoryLesson />} /><Route path="learn/environment-config" element={<EnvironmentConfig />} /><Route path="learn/logging-errors" element={<LoggingErrors />} /><Route path="learn/testing" element={<TestingLesson />} /><Route path="learn/deployment" element={<DeploymentLesson />} /><Route path="*" element={<Navigate to="/" replace />} /></Route></Routes>;
}
