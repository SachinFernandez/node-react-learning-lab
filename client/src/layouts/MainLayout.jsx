...
import { MenuRounded, SpaceDashboardRounded, TerminalRounded } from "@mui/icons-material";
...
const navigation = [{ label: "OVERVIEW", items: [{ label: "Dashboard", to: "/", icon: <SpaceDashboardRounded /> }] }, { label: "FOUNDATIONS", items: [{ label: "Node.js Introduction", to: "/learn/node-introduction", icon: <TerminalRounded /> }] }];
